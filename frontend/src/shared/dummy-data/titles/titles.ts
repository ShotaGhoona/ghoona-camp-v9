...
/** 称号一覧（保持者情報付き） */
export const dummyTitlesWithHolders: TitleWithHolders[] = TITLE_MASTER.map(
  (title) => ({
    ...title,
