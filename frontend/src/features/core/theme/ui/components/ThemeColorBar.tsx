...
export function ThemeColorBar({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'group flex w-full cursor-pointer items-center gap-3 rounded-xl px-3 py-2 transition-all duration-300',
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
        isSelected ? 'shadow-inset-sm' : 'hover:bg-muted/30',
      )}
    >
      {/* 色名 */}
      <span
      ...
      <div className='relative h-6 flex-1'>
        <div
          className={cn(
            ...
            isSelected ? 'w-full' : 'w-[15%] group-hover:w-[25%]',
          )}
