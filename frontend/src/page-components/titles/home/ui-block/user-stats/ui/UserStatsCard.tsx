...
export function UserStatsCard({ totalAttendanceDays, achievedTitlesCount }: UserStatsCardProps) {
  return (
    <Card variant="raised" className="flex h-full flex-col p-4">
      <p className="text-xs text-muted-foreground">あなたの記録</p>
      <div className="mt-3 flex flex-1 flex-col gap-3">
        {/* 総参加日数 */}
        <div className="flex flex-1 flex-col justify-center rounded-xl shadow-inset-sm p-3">
          <p className="text-2xl font-bold text-primary">{totalAttendanceDays}</p>
